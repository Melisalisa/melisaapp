...
import 'package:melisaapp/models/user.dart';
import 'package:melisaapp/models/finance.dart';
import 'package:melisaapp/constant/finance_type_constants.dart';
...
class DbHelper {
  ...
  void _createDb(Database db, int version) async {
    ...
    await db.insert("user", {'email': 'melisa@mail.com', 'password': 'melisa'});
  }
